...
### 🚀 About Me  
- 🏗 Разрабатываю мобильные приложения на **Flutter** и **Android**.  
- 🎓 Ментор в проекте **"Al Xorazmi"**, обучаю школьников web-разработке.  
- 🎮 Интересуюсь **игровой разработкой** (Defold, Godot, Phaser).  
- 💡 Люблю разбираться в технологиях и делиться знаниями.  
